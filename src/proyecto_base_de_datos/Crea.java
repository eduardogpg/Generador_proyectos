...
public class Crea extends javax.swing.JFrame {
   ...
   String Nombre;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Como Usuario Nuevo Tienes la obligación de ");

        jLabel2.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel2.setText("dar de alta un nuevo proyecto ");

        jLabel3.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel3.setText("Para que de esta manera la gente te conozca , Puede ser");

        jLabel4.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel4.setText("Un proyecto que ya a concluido o uno que aun esta en etapas iniciales");
